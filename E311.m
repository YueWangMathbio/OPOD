% this code produces Fig. 1 and corresponding data in Section 3.1.1
...
save E311A.dat A -ascii; % regret of policy pi_1
save E311C.dat C -ascii; % regret of policy pi_2
save E311D.dat D -ascii; % regret of policy pi_3
save E311E.dat E -ascii; % regret of policy pi_0
save E311F.dat F -ascii; % regret of policy pi_4
